...
public class LottoMadness extends JFrame {
    ...
    public LottoMadness() {
        super("Lotto Madness");
        LottoEvent lottoEvent=new LottoEvent(this);
        ...
        setLayout(layout);
        //Add listeners
        quickpick.addItemListener(lottoEvent);
        personal.addItemListener(lottoEvent);
        play.addActionListener(lottoEvent);
        stop.addActionListener(lottoEvent);
        reset.addActionListener(lottoEvent);
